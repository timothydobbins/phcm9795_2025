...
```{r fig-mod05-bwt-gender, echo=FALSE, out.width = "100%", fig.cap="Distribution of birth weight by gender"}
...
```{r fig-mod05-sbpdiff, echo=FALSE, out.width = "100%", fig.cap="Distribution of differences in ankle SBP between two sites of 107 participants"}
