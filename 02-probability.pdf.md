...
::: {.cell}
::: {.cell-output-display}
![Relative frequency of sex within stage of disease from PBC study](img/mod01/pbc-bar-stage-sex-stacked-relative.jpg){#fig-bar-4 fig-pos='H' width=75%}
:::
:::
...
::: {#tbl-2-5 .cell tbl-cap='Combinations and probabilities of Type A blood in three people'}
::: {.cell-output-display}
...
::: {#tbl-2-6 .cell tbl-cap='Probabilities of observing numbers of people with Type A blood in a sample of three people'}
::: {.cell-output-display}
