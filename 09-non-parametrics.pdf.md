...
::: {.cell}
::: {.cell-output-display}
![Length of hospital stay for 132 patients](img/mod09/mod09-los.png){#fig-mod09-los width=66%}
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Distribution of log transformed (length of stay + 1)](img/mod09/mod09-lnlos.png){#fig-mod09-lnlos width=66%}
:::
:::
