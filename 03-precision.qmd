...
```{r fig-age-pbc, echo=FALSE, out.width = "50%", fig.cap="Density plot of participant age from PBC study data"}
library(dplyr)
library(jmv)
library(flextable)
...
```{r fig-bili-pbc, echo=FALSE, out.width = "50%", fig.cap="Density plot of serum bilirubin from PBC study data"}
pbc <- pbc |> 
