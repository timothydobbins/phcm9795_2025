...
a) These data have been saved as `Activity_S1.1.rds`. Read the data into your software package.
...
### Activity 1.3 {-}
Estimate the mean, median, standard deviation, range and interquartile range for the data  `Activity_S1.3.rds`, available on Moodle.

### Activity 1.4 {-}
Data of diastolic blood pressure (BP) of a sample of study participants are provided in the datasets `Activity_S1.4.rds`. Compute the mean, median, range and SD of diastolic BP.
