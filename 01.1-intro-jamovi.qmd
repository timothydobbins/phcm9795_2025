...
Let's rename our variable from `A` to `age`. There are a number of ways of doing this: here we will click the **Data** tab which allows us to change aspects of our dataset, and then click **Setup**. By default, the first column is selected - you can choose any column simply by clicking it.
...
jamovi also has a way of opening and saving data, using the three lines in the upper-left corner: ![](img/mod01/jamovi/three-lines.png).

**MORE HERE ON THE FILE COMMANDS**
